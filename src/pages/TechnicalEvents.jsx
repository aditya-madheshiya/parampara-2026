...
const TechnicalEvents = () => {
  ...
  const techEvents = [
    ...
    { id: 4, name: "BGMI", link: "https://docs.google.com/forms/d/e/1FAIpQLSdJI_ssRxo1EyE2--6sLs0wO1xzOpU3WhbdTK5CmT_fb9CMWg/viewform?usp=publish-editor", image: bgmiImg },
    { id: 5, name: "FREE FIRE", link: "https://docs.google.com/forms/d/e/1FAIpQLScY76rBh1QOgJoMS5ff0r8jgaELD7VFoLmsdCqUF_7jPdnb6w/viewform?usp=dialog", image: freeFireImg },
    { id: 6, name: "Logic War", link: "https://forms.gle/D7VENrDh2YB9x37R9", image: logicWarImg },
    { id: 7, name: "Need For Speed", link: "https://docs.google.com/forms/d/e/1FAIpQLSeGSBlybMysguaWDdTet2riasJyS_KuzElCaojzYJ90FwwIgA/viewform?usp=publish-editor", image: nfsImg },
    { id: 8, name: "Robo War", link: "https://forms.gle/fHxptANwv46wN5Y49", image: roboWarImg },
    { id: 9, name: "Bridge Kriti", link: "https://forms.gle/xDmKvLPQufPVvVW47", image: bridgeKritiImg },
    { id: 10, name: "Vichar Yuddh", link: "https://docs.google.com/forms/d/e/1FAIpQLSdoRsWwhSv5eTbpCFNU94sMgnRerhhxbuQWerIp9ZfnF_8srQ/viewform?usp=header", image: vicharYuddhImg },
    { id: 11, name: "Junkyard (Recraft)", link: "https://docs.google.com/forms/d/e/1FAIpQLScJ1eoLy9FE0A3nN2r1D9rgHqW0c14aYfaHZX9x2V0w7eeGGQ/viewform?usp=preview", image: junkyardImg },
    { id: 12, name: "Rubiks War", link: "https://docs.google.com/forms/d/e/1FAIpQLSe0A-UDcNn1juR0lqm7X6DTTgyJcQ7ipURlv3BKjCpw6QRWLQ/viewform?usp=heade", image: rubiksWarImg },
    { id: 13, name: "Shark Tank", link: "https://forms.gle/9Rss7j6McZ2HGLyT7", image: sharkTankImg },
    { id: 14, name: "Kalpana Canvas", link: "https://docs.google.com/forms/d/e/1FAIpQLScLlUYuByTN3_ac6hJwWWoGN8AB-brCV0OanLO9KbeqX-qC8A/viewform?usp=header", image: kalpanaImg },
    { id: 15, name: "Riddle Master", link: "https://docs.google.com/forms/d/e/1FAIpQLSfB42_N_Bd9C27DJX5mdx0wFV3pNYinPb9Hi_dLBB1RHKPbuQ/viewform?usp=header", image: riddleImg },
    { id: 16, name: "Prescription Decoding", link: "https://forms.gle/HW4Xw5N6aVjx8dx76", image: prescriptionImg },
    { id: 17, name: "Lens Master", link: "https://docs.google.com/forms/d/e/1FAIpQLSc3Sjh5W5j4qeWCGEt2VnUjMWT1q4OX5KI6qnuPlkrnSFOp-A/viewform?usp=publish-editor", image: lensMasterImg },
    { id: 18, name: "Circuit Design", link: "https://forms.gle/NdocAXotejUiP6T49", image: circuitImg },
    { id: 19, name: "Science Exhibition (SR)", link: "https://forms.gle/CD68LKDn7fHgSbNR8", image: scienceSrImg },
    { id: 20, name: "Science Exhibition (JR)", link: "https://forms.gle/EUDCV9PUx59VFM587", image: scienceJrImg },
    { id: 21, name: "Blind Typing", link: "https://forms.gle/2pQYqKZKY4nHxcEL7 ", image: blindTypingImg },

...
// Hospitality Head folder se images import
  ...
  const heads = [
    {
      ...
      img: ujjwalImg,
      whatsapp: "919555697950" // Ujjwal ji ka number
    },
    {
      id: 2,
      ...
      role: "Hospitality Head",
      img: prakharImg,
      whatsapp: "917897573948" // Prakhar ji ka number
    }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        {heads.map((head) => (
          ...
          >
            ...
            {/* WhatsApp Button */}
            <a 
              href={`https://wa.me/${head.whatsapp}?text=Hi ${head.name}, I have a query regarding hospitality for Parampara 2026`}
              target="_blank"

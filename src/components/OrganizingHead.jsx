...
import akhandImg from '../assets/akhand.jpeg'; 

const OrganizingHead = () => {
  const whatsappNumber = "918953031336"; // Apna real number yahan dalein
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Akhand, I have a query about Parampara 2026`;
  ...
  return (
    ...
    <h2 className="text-3xl md:text-5xl font-black text-white uppercase italic text-center tracking-tighter leading-tight">
      Meet Our <span className="text-fest-gold">Core Members</span>
    </h2>
  </div>
      ...
      <div className="w-full max-w-[340px] sm:max-w-sm bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[2.5rem] shadow-2xl hover:border-fest-gold/30 transition-all duration-500 group text-center relative overflow-hidden">
        ...
        {/* Profile Picture Container - Responsive Size */}
        <div className="relative mx-auto w-44 h-44 sm:w-56 sm:h-56 mb-6 md:mb-8 p-1 border-2 border-fest-gold/20 rounded-[2rem] sm:rounded-[2.5rem] group-hover:border-fest-gold/50 transition-all duration-500">
          <img 
            ...
            onError={(e) => e.target.src = 'https://via.placeholder.com/300/ffcc00/000000?text=Akhand+Pratap'}
          />
        </div>
        ...
        {/* WhatsApp Button - Mobile Responsive Height */}
        <a 
          href={whatsappLink}
          target="_blank"
